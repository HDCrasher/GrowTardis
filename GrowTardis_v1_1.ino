...
const char* fan_topic = "home/esp32/fan"
...
void setup() {
    ...
    server.begin();
    Serial.begin(115200);
    Serial.println("ESP32-S3 GrowoBox_v1_1_0 MQTT nur Ausgabe");
...
void loop() {
    ...
    client.publish("home/esp32/temperature/temp_oben", temp_oben_str);
    client.publish("home/esp32/temperature/temp_unten", temp_unten_str);
    client.publish("home/esp32/humidity/hum_oben", hum_oben_str);
    client.publish("home/esp32/humidity/hum_unten", hum_unten_str);
